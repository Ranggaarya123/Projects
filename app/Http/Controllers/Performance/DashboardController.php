...
class DashboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('pages/performance/dashboard', [
    ...
    public function edit($id)
    {
        ...
        return view('mitra-manajemen.edit-performance', compact('mitraManajemen'),[
            'validasitacticalPending' => $validasitacticalPending,
            'createaktivasiMyiSCMTPending' => $createaktivasiMyiSCMTPending,
            'duplicatePending' => $duplicatePending,
            'pindahPending' => $pindahPending,
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('dashboardPerformance')->with('success', 'Data updated successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('dashboardPerformance')->with('success', 'Data deleted successfully');
    }
    ...
    public function create()
    {
        ...
        return view('mitra-manajemen.create-performance',[
            'validasitacticalPending' => $validasitacticalPending,
            'createaktivasiMyiSCMTPending' => $createaktivasiMyiSCMTPending,
            'duplicatePending' => $duplicatePending,
            'pindahPending' => $pindahPending,
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dashboardPerformance')->with('success', 'Data added successfully');
    }
    ...
    public function showUploadForm()
    {
        ...
        return view('mitra-manajemen.import-excel-performance',[
            'validasitacticalPending' => $validasitacticalPending,
            'createaktivasiMyiSCMTPending' => $createaktivasiMyiSCMTPending,
            'duplicatePending' => $duplicatePending,
            'pindahPending' => $pindahPending,
    ...
    public function import(Request $request)
    {
        ...
        if (!empty($duplicateUserIds)) {
            return redirect()->route('dashboardPerformance')->with('warning', 'Data imported with some duplicate user_ids: ' . implode(', ', $duplicateUserIds));
        }
    
        return redirect()->route('dashboardPerformance')->with('success', 'File imported successfully.');
    }
