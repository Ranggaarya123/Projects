...
@section('content')
    <div class="card mt-4">
        <div class="card-body text-center bg-primary text-white">
            <h3 class="my-0 fw-bold text-accent-border">HCM Approval - Aktivasi NIK</h3>
        </div>
    </div>
    <div class="card mt-4">
        <!-- Search Input -->
        ...
        <div class="card-body">
            ...
            <table class="table table-striped table-hover" id="table-content">
                ...
                <tbody>
                    @foreach ($aktivasiNik as $item)
                        <tr data-user-id="{{ $item->user_id }}">
                            <td>{{ $item->user_id }}</td>
                            <!-- Button for showing PDF in modal -->
                            <td><a href="javascript:void(0);" onclick="openPdfModal('{{ asset('storage/' . $item->surat_keterangan_aktif) }}', 'Surat Keterangan Aktif')" class="btn"><i class="fas fa-eye"></i></a></td>
                            ...
                            <td><a href="javascript:void(0);" onclick="openPdfModal('{{ asset('storage/' . $item->sertifikat_brevet) }}', 'Sertifikat Brevet')" class="btn"><i class="fas fa-eye"></i></a></td>
                            ...
                            <td>
                                ...
                                @else
                                    <form action="{{ url('/hcm/approval/aktivasi-nik/' . $item->id) }}" method="POST">
                                        @csrf
                        ...
                        <!-- Modal for rejection and approval -->
