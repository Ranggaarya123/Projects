...
@section('content')
    ...
    <div class="card mt-4">
        ...
        <div class="card-body">
                ...
                <tbody id="table-body">
                    @foreach ($createMitraManajemen as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('mitra-manajemen.edit-hcm', $item->id) }}" class="btn btn-warning btn-sm" data-export="false">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal" data-url="{{ route('mitra-manajemen.destroy-hcm', $item->id) }}">
            ...
            <div class="d-flex">
                <a href="{{ route('mitra-manajemen.create-hcm') }}" class="btn mr-2" style="background-color: #607d8b; margin-right: 10px;" >Add Employee</a>
                <a href="{{ route('mitra-manajemen.import-excel-hcm') }}" class="btn mr-2" style="background-color: #607d8b" >Add By Excel</a>
            </div>
    ...
    <div class="card mt-4">
        ...
        <h5 class="my-2">Filter Tanggal</h5>
            <form method="GET" action="{{ route('dashboardHCM') }}">
                <div class="form-row">
