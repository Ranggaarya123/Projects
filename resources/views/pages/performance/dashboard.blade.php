...
@section('content')
    ...
    <div class="card mt-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h4 class="my-2 fw-bold text-center">Employee Management</h4>
            <div class="d-flex">
        ...
        <div class="card-body">
                ...
                <tbody id="table-body">
                    @foreach ($createMitraManajemen as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('mitra-manajemen.edit-performance', $item->id) }}" class="btn btn-warning btn-sm" data-export="false">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal" data-url="{{ route('mitra-manajemen.destroy-performance', $item->id) }}">
            ...
            <div class="d-flex">
                <a href="{{ route('mitra-manajemen.create-performance') }}" class="btn mr-2" style="background-color: #607d8b; margin-right: 10px;" >Add Employee</a>
                <a href="{{ route('mitra-manajemen.import-excel-performance') }}" class="btn mr-2" style="background-color: #607d8b" >Add By Excel</a>
            </div>
    ...
    <div class="card mt-4">
        ...
        <h5 class="my-2">Filter Tanggal</h5>
            <form method="GET" action="{{ route('dashboardPerformance') }}">
                <div class="form-row">
    ...
    <script>
        ...
        $('#deleteModal').on('show.bs.modal', function (event) {
            ...
            var url = button.data('url'); // Extract the URL from the data-* attributes
            
            var modal = $(this);
            modal.find('#deleteForm').attr('action', url); // Set the form action to the URL
        });
    </script>
